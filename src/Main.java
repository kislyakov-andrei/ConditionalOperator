public class Main {
    public static void main(String[] args) {
        ...
        if (speed1 < 60)
        {
            ...
            int age3 = 5; // variant for first age
                      if (age3 > 2 && age3 <= 6) {
            ...
            int age4=14;
                    if (age4 < 5) {
                System.out.println("Если возраст ребенка равен " + age4 + ", то ему нельзя кататься на атракционе.");
            }
            ...
            {
                System.out.println("Если возраст ребенка равен " + age4 + ", то ему можно кататься на атракционе без сопровождения взрослого");
            }
            //Task 6
